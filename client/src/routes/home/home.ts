...
import thumb5 from './thumbnails/form5.png';
...
export class Home extends FASTElement {
  ...
  public tutorials: Array<Tutorial> = [
    ...
    new Tutorial(
      ...
      'https://github.com/genesislcap/genesis-gks/tree/develop/client/src/routes/foundation-layout-intro',
      thumb7,
    ),
    new Tutorial(
      ...
      'list-items',
      'https://github.com/genesislcap/genesis-gks/tree/develop/client/src/routes/list-items',
      thumb8,
    ),
  ];
  constructor() {
